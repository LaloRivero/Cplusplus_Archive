	...
	while (readfull(&__in, &__msgid, sizeof(__msgid), 0)) {
		...
		switch (__msgid) {
			case 0x13857295u: {
				...
				uint32_t __cookie;
				int inicio_n;
				readfull(&__in, &inicio_n, sizeof(int), 1);
...
int main(int argc, char* argv[]) {
	...
	openstream(&__in, "\\\\.\\pipe\\libinteractive_Bubble_Bubble_in", O_RDONLY);
	openstream(&__out, "\\\\.\\pipe\\libinteractive_Bubble_Bubble_out", O_WRONLY);
